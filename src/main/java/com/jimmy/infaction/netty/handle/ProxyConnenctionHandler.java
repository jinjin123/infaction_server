...
import com.jimmy.infaction.netty.client.NettyClient;
...
public class ProxyConnenctionHandler extends ChannelInboundHandlerAdapter {
	...
	private EventLoopGroup remoteLoopGroup = NettyClient.REMOTEWORKER;
	...
	public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
		...
		bootstrap.connect(NettyClient.serverHost, NettyClient.serverPort).addListener(future -> {
			if (future.isSuccess()) {
